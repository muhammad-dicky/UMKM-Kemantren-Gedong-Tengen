...
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/bg_1.jpg'); ?>');">
    <div class="container text-dark">
      <div class="row no-gutters slider-text align-items-center justify-content-center text-dark">
        <div class="col-md-9 ftco-animate text-center ">
            <p class="breadcrumbs text-dark"><span class="mr-2 text-dark"><?php echo anchor(base_url(), 'Home'); ?></span> <span> Tentang Kami</span></p>
          <h1 class="mb-0 bread text-dark">Tentang Kami</h1>
        </div>
      </div>
    </div>
  </div>
