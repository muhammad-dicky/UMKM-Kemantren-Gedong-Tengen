      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-3" style="font-family:serif;">"Bakpia Jogja: Tradisi dalam Setiap Gigitan!"</h1>
            <h2 class="subheading mb-4"style="font-family:serif;">Flavors of Yogyakarta in Every Bite!</h2>
      ...
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            <h1 class="mb-2"style="font-family:serif;">Nikmati Kenikmatan Legendaris dari Tanah Raja-Raja!</h1>
            <h2 class="subheading mb-4"style="font-family:serif;">"Jogja's Delight in Every Bite!"</h2>
            <p><a href="#products" class="btn btn-primary">Buy Now!</a></p>
          </div>
